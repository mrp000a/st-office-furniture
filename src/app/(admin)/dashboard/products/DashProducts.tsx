...
import ProductAdmin from "../_dash_components/components/adminProduct";
  ...
  return (
      ...
      <div className="box-border">
          ...
          <div className="gap-1 flex items-center flex-wrap ">
            ...
            >
              <button
                ...
                onClick={async () =>
                  router.push(
                    `/dashboard/products?search=${searchProductString}`,
                  )
                }
              >
                <Search />
        ...
        >
          ...
          <span
            className={`${searchCategoryString.length > 0 ? "" : "hidden"}`}
          >
            Category : {`"${searchCategoryString}"`}
          </span>
          <Button
