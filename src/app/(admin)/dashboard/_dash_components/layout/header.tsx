...
const DashHeader = ({
  ...
  return (
    <div className="flex sticky top-0 z-999 justify-between gap-1 md:gap-4 items-center bg-gray-secondary/20 backdrop-blur-sm px-2  rounded-sm border border-gray-secondary">
      {/* logo */}
