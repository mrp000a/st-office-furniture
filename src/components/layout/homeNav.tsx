        ...
        <>
          ...
          >
            ...
            <div className="w-full py-2 px-1 sm:px-3 h-full justify-center items-center flex relative">
              ...
              ${
                showSearchBar
                  ? "flex translate-y-14 opacity-100"
            ...
            <div className="w-full bg-red-primary py-1 text-xs md:text-xs lg:text-sm">
              <div className=" max-w-384 mx-auto px-2 flex justify-start items-center sm:gap-3">
                ...
                <div className="flex justify-start items-center gap-3 text-background  max-md:hidden overflow-hidden">
                  {CategoriesNav.map(({ label, href }, index) => (
                    <Button
                      key={index}
                      // size={"xs"}
            ...
            <div className="flex w-full justify-between gap-2 overflow-visible">
              {MobNavItems.map(({ href, label, Logo: Logo }, index) => (
                <button
                  ...
                  key={index}
                  className={` ${label.toLowerCase() == "home" ? "relative z-30 rounded-full bg-red-primary text-background p-1 px-2  ring ring-gray-primary shadow-lg shadow-yellow-500 -translate-y-4" : `px-2 py-1 flex-center flex-col flex-1 rounded-sm hover:bg-background active:bg-violet-primary transition-all hover:outline hover:outline-gray-primary/40 border border-gray-primary  cursor-pointer ${pathname.startsWith(href) ? "bg-blue-secondary text-background" : " bg-background"} `}`}
                >
                  {Logo && (
                    <Logo
